...
public class ex1_knuth {
    ...
    public static void main(String[] args) throws IOException {
        ...
        data = Repeater.repeater_knuth(ex1_knuth::func, repeat_times, array_n_size);
        ...
        CsvExporter.write_csv_knuth("dadosMediosEx1Knuth.csv", string_array);
